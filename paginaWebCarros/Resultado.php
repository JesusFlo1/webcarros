...
<body>
    ...
    <div id="contenedor">
        ...
        <?php 
            ...
            $link=Conectarse(); 
            $sSQL="Select * From autos where codigoconsulta = '$modelo'";
            $result2=mysqli_query($link,$sSQL);
            echo "<br>";
            
            $row = mysqli_fetch_array($result2);
            printf(" <tr><td>&nbsp;%s<br>   </td><td>&nbsp;%s <br>  </td><td>&nbsp;%s <br>  </td> </tr> <br>", $row["codigoconsulta"],$row["marca"],$row["motor"]);
            $imagen = $row["imagen"];
            echo "<img src=$imagen style='width: 380px;height: 300px;'>"; 
        ?><!--img src=https://media3.giphy.com/media/3oriO8PMMygH4IrF4Y/source.gif style="width:100%;height:auto;"/-->
        </div>
        <div id="derecha">
        <?php 
            $modelo = $_POST['selec2'];
            ...
            printf(" <tr><td>&nbsp;%s<br>   </td><td>&nbsp;%s <br>  </td><td>&nbsp;%s <br>  </td> </tr> <br>", $row["codigoconsulta"],$row["marca"],$row["motor"]); 
            $imagen = $row["imagen"];
            echo "<img src=$imagen style='width: 300px;height: 300px;'>"; 
        ?><!--img src=https://media3.giphy.com/media/3oriO8PMMygH4IrF4Y/source.gif style="width:100%;height:auto;"/-->
        </div>
    </div>
	</main>	
